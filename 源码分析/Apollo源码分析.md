...
向BeanDefinitionRegistry中注册PropertySourcesProcessor和ApolloAnnotationProcessor、SpringValueProcessor、SpringValueDefinitionProcessor、ApolloJsonValueProcessor，



1、解析注解，ApolloConfigRegistrar，获取设置的namespace
...
**实现了BeanFactoryPostProcessor接口，在Bean实例化之前加载配置文件**
